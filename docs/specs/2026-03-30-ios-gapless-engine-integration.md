...
- 2026-03-31: Added a fixed `44,100 Hz` stereo session-output normalizer for the native gapless engine, relaxed mixed-format prepare/setNext to “normalizable” inputs, added harness coverage plus derived `44.1k` and mono MP3 fixtures for mixed-format playback, reran `yarn pods`, and found the canonical native build blocked by disk-full DerivedData rather than a compiler error. (019d4087-5419-77f2-b446-ce61e5cab2a9)
