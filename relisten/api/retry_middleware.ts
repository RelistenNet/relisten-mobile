/**
 * This file is from https://github.com/elbywan/wretch/blob/master/src/middlewares/retry.ts
 *
 * Metro was unable to import it from wretch/middlewares and I couldn't figure out why.
 */
...
const defaultDelayRamp: DelayRampFunction = (delay, nbOfAttempts) => delay * nbOfAttempts;
              ...
              setTimeout(() => {
                if (typeof onRetry === 'function') {
                  Promise.resolve(
                    ...
                    resolve(
                      next((values && values.url) ?? url, (values && values.options) ?? opts)
                    );
                  });
                } else {
