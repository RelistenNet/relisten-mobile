import wretch, { ConfiguredMiddleware, WretchError, WretchOptions } from 'wretch';
...
import { getRelistenCatalogApiBaseUrl } from '@/relisten/api/config';
...
export class RelistenApiClient {
  static API_BASE = getRelistenCatalogApiBaseUrl();
