...
export const createRepoQueryHook = <TModel extends Model & CopyableFromApi<TApiModel> & UpdatableFromApi,
            ...
            dbQuery.subscribe(async dbResults => {
                ...
                if (receivedFirstResult) {
                    ...
                    if (doNetwork) {
                        ...
                        const networkResultsByUuid = R.flatMapToObj(networkResults, apiModel => [[apiModel.uuid, apiModel]])
