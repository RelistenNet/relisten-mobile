/*
	...
	Copyright (c) 2004-2023 Un4seen Developments Ltd.
...
public class BASSFLAC
{
	...
	public static native int BASS_FLAC_StreamCreateFile(BASS.Asset file, long offset, long length, int flags);
	public static native int BASS_FLAC_StreamCreateFile(ParcelFileDescriptor file, long offset, long length, int flags);
