...
export function SourceFullFromJSON(json: any): SourceFull {
    return {
        ...
        'sets': (json['sets'] as Array<any>).map(SourceSetFromJSON),
...
export function SourceFullToJSON(value?: SourceFull): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'review_count': value.reviewCount,
        'sets': (value.sets as Array<any>).map(SourceSetToJSON),
