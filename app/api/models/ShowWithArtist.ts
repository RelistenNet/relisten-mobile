...
export function ShowWithArtistFromJSON(json: any): ShowWithArtist {
    return ShowWithArtistFromJSONTyped(json, false);
}

export function ShowWithArtistFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowWithArtist {
...
export function ShowWithArtistToJSON(value?: ShowWithArtist | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
